...
package edu.jhu.cs.gren3.oose.shuffletter;
...
//		}
		...
		for (String s : gridWords) {
			System.out.println("grid words contain : " + s.toLowerCase());
		}
...
//				System.out.println ("valid char set after wild : " + validChar.size());
...
//				}
	...
	private boolean checkConnectivity() {
		...
		for (Set<Position> set : sets) {
			for (Position p : set) {
				System.out.print (this.gameGrid.get(p).getLetter() + " ");
			}
			System.out.println();
		}
